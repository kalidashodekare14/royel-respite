...
const UpdateProfile = () => {
    ...
    return (
        <div className='flex justify-center items-center my-5'>
            <div className="card w-1/3 border border-spacing-1   bg-base-100 shadow-xl">
                <h1 className='text-center text-4xl my-5'>Update Your Profile</h1>
                <div className='flex justify-center'>
                    <img className='w-32 rounded-full' src={user.photoURL} alt="" />
                </div>
                <div className="px-3">
                    <form className='space-y-2 mb-5' onSubmit={handleUpdateProfile}>
                        <p className='text-[18px]'>Name: {user.displayName}</p>
                        <input className='input input-bordered w-full' name='name' type="name" />
                        <br />
                        <p className='text-[18px]'>Enter Your Photo Url</p>
